...
This section presents the predicted probability of employee attrition using [two predictive models](https://github.com/rowin0/HR-Attrition-Analysis/blob/main/P2-predictive%20models.pdf).
...
The [two predictive models](https://github.com/rowin0/HR-Attrition-Analysis/blob/main/P2-predictive%20models.pdf) utilize selected features or metrics identified through Recursive Feature Elimination (RFE),a method that picks features by importance and removes the least significant ones, this increases model efficiency and performance, as can be seen here.\
